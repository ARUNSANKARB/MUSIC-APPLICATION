          ...
          </div>
          {
            ...
            <article className="flex gap-3 py-2 px-6">
              <div className="w-[300px] flex items-center gap-2 bg-gray-800 p-4 rounded">
                ...
                <span className="flex items-center border w-[230px] h-[30px] border-gray-600 rounded text-gray-300 px-3">{userData.displayName}</span>
              </div>
              <div className="w-[300px] flex items-center gap-2 bg-gray-800 p-4 rounded">
                <span className="text-lg font-semibold py-1">Contact</span>
                <span className="flex items-center border w-[230px] h-[30px] border-gray-600 rounded text-gray-300 px-3">{userData.contactNumber}</span>
              </div>
              <div className=" w-[300px] flex items-center gap-2 bg-gray-800 p-4 rounded">
                <span className="text-lg font-semibold py-1">Gender</span>
                <span className="flex items-center border w-[230px] h-[30px] border-gray-600 rounded text-gray-300 px-3">{userData.gender}</span>
              </div>
            </article>
            <article className="flex gap-3 py-2 px-6">
              <div className="w-[300px] flex items-center gap-2 bg-gray-800 p-4 rounded">
                <span className="text-lg font-semibold py-1">DOB</span>
                <span className="flex items-center border w-[230px] h-[30px] border-gray-600 rounded text-gray-300 px-3">{userData.dob}</span>
              </div>
              <div className="w-[300px] flex items-center gap-2 bg-gray-800 p-4 rounded">
                <span className="text-lg font-semibold py-1">Age</span>
                <span className="flex items-center border w-[230px] h-[30px] border-gray-600 rounded text-gray-300 px-3">{userData.age}</span>
              </div>
              <div className="w-[300px] flex items-center gap-2 bg-gray-800 p-4 rounded">
                <span className="text-lg font-semibold py-1">Language</span>
                <span className="flex items-center border w-[230px] h-[30px] border-gray-600 rounded text-gray-300 px-3">{userData.lang}</span>
              </div>
            </article>
            <article className="flex gap-3 py-2 px-6">
              <div className="w-[300px] flex items-center gap-2 bg-gray-800 p-4 rounded">
                <span className="text-lg font-semibold py-1">Country</span>
                <span className="flex items-center border w-[230px] h-[30px] border-gray-600 rounded text-gray-300 px-3">{userData.country}</span>
              </div>
              <div className="w-[300px] flex items-center gap-2 bg-gray-800 p-4 rounded">
                <span className="text-lg font-semibold py-1">State</span>
                <span className="flex items-center border w-[230px] h-[30px] border-gray-600 rounded text-gray-300 px-3">{userData.state}</span>
              </div>
              <div className="w-[300px] flex items-center gap-2 bg-gray-800 p-4 rounded">
                <span className="text-lg font-semibold py-1">City</span>
                <span className="flex items-center border w-[230px] h-[30px] border-gray-600 rounded text-gray-300 px-3">{userData.city}</span>
              </div>
            </article>
            <article className="flex py-2 px-6">
              <div className="flex items-center gap-2 bg-gray-800 p-4 rounded">
                ...
                <span className="flex items-center border w-[810px] h-[60px] border-gray-600 rounded text-gray-300 px-3">{userData.address}</span>
              </div>
            </article>
          </aside>)
          }
