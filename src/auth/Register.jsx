...
const Register = () => {
  ...
  let handleSubmit = async (e) => {
    ...
    try {
      ...
      //! Updated profile name and photo url which is not updated by default
      updateProfile(registeredUser.user, { 
        displayName: username,
        photoURL: "https://thumbs.dreamstime.com/b/user-sign-icon-person-symbol-human-avatar-rich-man-84519083.jpg"
       });
      toast.success(`Email verification has been sent to your registered email: ${email}`);
